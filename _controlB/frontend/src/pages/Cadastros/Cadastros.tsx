  ...
  return <div className="cadastros-page"><div className="cadastros-layout">
    <aside className="sidebar-left">
      ...
      <nav className="sidebar-menu-list">
        <button type="button" className="sidebar-menu-btn" onClick={() => navigate('/contatos')}><div className="btn-label"><Users size={16} /><span>Contatos</span></div><ChevronRight size={14} /></button>
